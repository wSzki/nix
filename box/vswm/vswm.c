...
static Key keys[] = {
	{ Mod4Mask, XK_Return, launch, "st" },
	/*{ Mod4Mask, XK_d, launch, "dmn" },*/
	{ Mod4Mask, XK_i, launch, "chromium" },
	{ Mod4Mask, XK_p, launch, "scr" },
	{ Mod4Mask | ShiftMask, XK_c, destroy, 0 },
	{ Mod4Mask, XK_equal, focus, "next" },
	{ Mod4Mask, XK_minus, focus, "prev" },
