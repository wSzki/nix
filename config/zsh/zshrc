...
######################## NIX ###################################
alias nrc="vim ~/.nix/config/nix/configuration.nix"
alias rebuild="~/.nix/bin/nix/rebuild"
alias tmux="tmux -f ~/.nix/config/tmux/tmux.conf"
alias gitap="git add . && git status && git commit -m backup && git push"
alias back="cd ~/.nix && gitap"
######################## TMUX ###################################
...
alias vrc="cd $DOTFILES/nvim  && vim -c 'NeoTreeFocusToggle' && cd -"
...
########################## TIDAL ######################################
alias tdv="tdvk ; ~/.nix/bin/tidal/bin/tidalvim ~/.nix/bin/tidal/main.tidal"
